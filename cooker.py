...
def cooker (  orMj ,  orSm , iX=0 , iZ=0 , iY=0 ):
   ...
   crtaj_kvadar ( orMj , ( -1 , -1 , -1 )  , ( 1 , 1 , 1  ) , orSm , 98 , 0 ) #temelji od stomebricks
   crtaj_kutiju ( orMj , ( -1 , 0 , -1 )  , ( -1 , 0 , -1 ) , orSm , rel_smjer  = "meni" ) # storage
   crtaj_hopper    ( orMj , ( 0 , 0 , -1 )  , ( 1 , 0 , -1 ) , orSm ,  rel_smjer = "meni" )  #hoppers 
   crtaj_kvadar ( orMj , ( -1 , 0 , 0 )  , ( -1 , 0 , 0  ) , orSm , 0 , 0 ) # access
